...
def DashboardWindow(username: str, role: str, session_id: Optional[int] = None):
    ...
    if role == "admin":
        ...
        try:
            ...
            return EnhancedAdminDashboard(username)
        except ImportError as e:
            print(f"Failed to import EnhancedAdminDashboard: {e}")
            # Fallback ke simple admin dashboard
            return AdminDashboardSimple(username, session_id)
...
class AdminDashboardSimple(QtWidgets.QMainWindow):
    ...
    def __init__(self, username: str, session_id: Optional[int] = None):
        ...
        # Heartbeat
        if session_id:
            from app_db_fixed import heartbeat
    ...
    def _setup_simple_ui(self):
        ...
        # Presence table
        from app_db_fixed import latest_presence_per_user
